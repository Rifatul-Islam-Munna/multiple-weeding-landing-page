...
const RSVPModal = ({ data }: RSVPModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // ✅ Show success banner — do NOT call handleReset() here
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && close()}>
      ...
      >
        ...
        >
          ...
          {/* Scrollable Guest List — hidden on success */}
          {!isSuccess && (
            <div
              ref={scrollRef}
          ...
          >
            ...
            >
              {/* ✅ Show "Close" after success, otherwise show reset label */}
              {isSuccess ? (data.closeLabel ?? "Close") : data.resetLabel}
            </button>
